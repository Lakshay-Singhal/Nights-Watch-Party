...
import Lakshay from './Lakshay.jpg';
import Pradyumn from './Pradyumn.jpg';
...
//  style={{ backgroundColor: '#181A1B' }}
                        ...
                        <Form >
                            <Form.Group controlId="landingForm.ControlInput1">
                                <Form.Label className={"form_style"}>Your Name</Form.Label>
                                        <Form.Control style={{ backgroundColor: "#181A1B", borderColor: '#3C4144', color:'#fff' }} required onChange={(evt) => this.state.name = evt.target.value}
                                              placeholder="Human"/>
                            </Form.Group>
                            <Form.Group controlId="landingForm.ControlInput2">
                                <Form.Label className={"form_style"}>Party Name</Form.Label>
                                        <Form.Control style={{ backgroundColor: "#181A1B", borderColor: '#3C4144',color:'#fff' }} required  onChange={(evt) => this.state.title = evt.target.value}
                                              placeholder="Nights Watch Party!"/>
                            </Form.Group>
                            <Form.Group controlId="landingForm.ControlInput1">
                                        <Form.Label  className={"form_style"}>Video Link</Form.Label>
                                        <Form.Control style={{ backgroundColor: "#181A1B", borderColor: '#3C4144', color: '#fff' }} required onChange={(evt) => this.state.url = evt.target.value}
                        ...
                        <Form>
                            ...
                            <Form.Group controlId="landingForm.ControlInput2">
                                <Form.Label className={"form_style"}>Room ID</Form.Label>
                                        <Form.Control style={{ backgroundColor: "#181A1B", borderColor: '#3C4144', color: '#fff'}} required onChange={(evt) => this.state.room_id = evt.target.value}
                                              placeholder="Room Id"/>
                            </Form.Group>
                        </Form>
                    </Row>
    ...
    > */}
                        <Col md={10} className={'m-3 p-5   rounded'} style={{ backgroundColor: "#2B2F31" }}  >
                            ...
                            <br/>
                            {/* <a href={'https://www.youtube.com/watch?v=k0EZbWbLjjc'} target={'_blank'} ><h3> Demo Video on Youtube </h3></a> */}
                            <p className={'descp'} >
